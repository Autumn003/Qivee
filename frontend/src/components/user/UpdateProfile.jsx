    ...
    <>
      <div className="updateProfileContainer w-screen h-screen max-w-[100%] flex justify-center items-center bg-slate-200 fixed top-0 left-0">
        <div className="updateProfileBox bg-white w-80 sm:h-4/5 h-[65%] box-border rounded-2xl">
          ...
          <form
            className="updateProfileForm bg-white flex flex-col items-center justify-evenly"
            encType="multipart/form-data"
            onSubmit={updateProfileSubmit}
          >
            <div className="updateProfileName flex items-center w-[100%]">
            ...
            <div className="updateProfileEmail flex items-center w-[100%]">
            ...
            <div className="updateProfileImage flex items-center w-[100%] px-10">
              <img
                src={avatarPreview}
                alt="Avatar Preview"
